...
export const PC = ({ visiblePC, item, setVisiblePC, isLoading }) => {
        ...
        axios({
            ...
            .then((response) => {
                ...
                Alert.alert(
                    ...
                    [{ text: 'Закрыть', onPress: () => setVisiblePC(false) }])
            });
    }
        ...
        >
            ...
            <View style={{ marginTop: 16 }} >
                {isLoading ? <Text>Loading</Text> :
                    <View>
                        <Button title={'Назад'} onPress={() => setVisiblePC(false)} color={'#121212'} />
                        <View style={{ paddingHorizontal: 16 }}>
                            ...
                            <Property name={'Тип'} value={item.type.title} />
                            ...
                            <Property name={'Оперативная память'} value={item.ram.title} />
                            <Property name={'Объём'} value={item.ram.volume} child={true} />
